...
# create project
create_project timapulpemu . -part $::env(XILINX_PART)
...
add_files -norecurse ../rtl/timapulpemu_top.vhd
update_compile_order -fileset sources_1
update_compile_order -fileset sim_1
...
# write_edif timapulpemu.edf

# export hardware design for sdk
write_hwdef -force -file ./timapulpemu.hwdef
