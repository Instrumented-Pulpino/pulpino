...
if {[string equal $::env(BOARD) "zybo"]} {
  ...
  # ----------------------------------------------------------------------------
  set_property PACKAGE_PIN Y11  [get_ports {tdi_i}];     # "P-MOD: JA1"
  set_property PACKAGE_PIN AA11 [get_ports {tms_i}];     # "P-MOD: JA2"
  set_property PACKAGE_PIN Y10  [get_ports {tck_i}];     # "P-MOD: JA3"
  set_property PACKAGE_PIN AA9  [get_ports {tdo_o}];     # "P-MOD: JA4"
  set_property PACKAGE_PIN AB11 [get_ports {trstn_i}];   # "P-MOD: JA7"
...
report_utilization -hierarchical -hierarchical_depth 1 -file timapulpemu.txt
report_utilization -hierarchical -hierarchical_depth 2 -cells pulpino_wrap_i -file pulpino.txt

report_timing_summary -file timapulpemu_timing_summary.txt
report_timing         -file timapulpemu_timing.txt         -max_paths 10
...
if { [info exists ::env(PROBES)] } {
   ...
   set_property incremental_checkpoint timapulpemu.runs/impl_1/timapulpemu_top_routed.dcp [get_runs impl_2]
